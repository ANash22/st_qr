...
Revision ID: 833fa7af1d88
Revises: 
Create Date: 2018-03-20 16:48:38.814000
...
def upgrade():
    ...
    op.create_table('q_rcode',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=60), nullable=True),
    sa.Column('description', sa.String(length=200), nullable=True),
    sa.Column('qrcontent', sa.String(length=200), nullable=True),
